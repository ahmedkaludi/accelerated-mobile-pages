    ...
    <?php
        ...
        if(is_plugin_active( 'amp/amp.php' ) ){
            ...
            if(in_array($section['id'], $enabledOptions)){
                $hide_wrapper = '<div class="ampforwp_addon_mode"><div class="hide-wrapper"></div><div class="amp-watermark-wrapper"><a class="amp-watermark" href="https://ampforwp.com/tutorials/article-categories/setup-amp/amp-by-automattic-support" target="_blank">
