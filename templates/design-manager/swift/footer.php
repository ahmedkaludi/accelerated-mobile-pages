...
<div class="s_stk ss-ic">
	<ul>
		...
		<li>
			<a title="tumblr share" class="s_tb" target="_blank" <?php ampforwp_nofollow_social_links(); ?> href="https://www.tumblr.com/widgets/share/tool?canonicalUrl=<?php echo $amp_permalink ?>"></a>
		</li>
		<?php } ?>
