...
<?php do_action('ampforwp_before_social_icons_hook',$this); ?>
	<div class="ampforwp-social-icons">
		...
		<amp-social-share type="facebookmessenger"
		    ...
		    data-param-text="<?php echo esc_url($amp_permalink); ?>" <?php ampforwp_nofollow_social_links(); ?>>
		</amp-social-share>
		<?php } ?>
	...
	<?php if ( true == ampforwp_get_setting('enable-single-flipboard-share') ) { ?>
			<a title="flipboard share" <?php ampforwp_nofollow_social_links(); ?> href="https://share.flipboard.com/bookmarklet/popout?v=<?php echo get_the_title(ampforwp_get_the_ID()); ?>&url=<?php echo urlencode(esc_url($amp_permalink)); ?>" target="_blank">
