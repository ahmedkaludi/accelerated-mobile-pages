...
/* Global Styling */
body{ background: #f1f1f1; font: 16px/1.4 Sans-serif;<?php echo ampforwp_font_selector('body'); ?>}
...
h2.amp-wp-title , .amp-wp-post-content p{ margin: 0 0 0 5px; word-wrap: break-word;}
/* For Excerpt */
...
.the_content p{ margin-top: 5px; color: #333; font-size: 15px; line-height: 26px; margin-bottom: 15px;word-wrap: break-word; }
...
.single-post .amp_author_area .amp_author_area_wrapper{ display: inline-block; width: 100%; line-height: 1.4; margin-top: 2px; font-size: 13px; color:#333; font-family: sans-serif;<?php echo ampforwp_font_selector('body');?> }
<?php if(is_single()){
...
.related_posts ol li p{ font-size: 12px; color: #999; line-height: 1.2; margin: 12px 0 0 0;word-wrap: break-word;}
...
<?php if(!is_home() && true == ampforwp_get_setting('ampforwp-bread-crumb') && !checkAMPforPageBuilderStatus(get_the_ID()) ) { ?>
...
.full-post .amp-wp-title{text-align:center;}
...
@media(max-width:480px){
  <?php if ( is_active_sidebar( 'ampforwp-above-footer'  ) || is_active_sidebar( 'ampforwp-below-header'  ) || is_active_sidebar( 'ampforwp-above-loop'  ) || is_active_sidebar( 'ampforwp-below-loop'  ) ) : ?>
    .f-w{ display: inline-block;margin:0;}
    .w-bl{flex:1 0 100%;}
  <?php endif; ?>
}
