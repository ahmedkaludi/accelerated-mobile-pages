...
function ampforwp_sticky_social_icons(){
	...
	if( (ampforwp_get_setting('enable-single-social-icons') == true && is_single()) || (is_page() && true == $redux_builder_amp['ampforwp-page-sticky-social']))  { 
		...
		<?php if($redux_builder_amp['enable-single-odnoklassniki-share'] == true)  { 
			...
			?>
			<a title="odnoklassniki share" <?php ampforwp_rel_attributes_social_links(); ?> href="https://connect.ok.ru/offer?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars(get_the_title())); ?>&imageUrl=<?php echo esc_url($feature_img); ?>" target="_blank">
