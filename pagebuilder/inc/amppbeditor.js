...
( function( $, wp ) {
	...
	function SwitchEditors() {
		...
		wp.ampeditor.autop = wpautop;
		wp.ampeditor.removep = pre_wpautop;
	 ...
	 * }
	 */
	wp.ampeditor.initialize = function( id, settings ) {
		var init;
		var defaults;

		if ( ! $ || ! id || ! wp.ampeditor.getDefaultSettings ) {
			return;
		}

		defaults = wp.ampeditor.getDefaultSettings();
	 ...
	 *
	 * Intended for use with editors that were initialized with wp.ampeditor.initialize().
	 *
	 * @since 4.8
	 *
	 * @param {string} id The HTML id of the editor textarea.
	 */
	wp.ampeditor.remove = function( id ) {
	 ...
	 */
	wp.ampeditor.getContent = function( id ) {
		var editor;
