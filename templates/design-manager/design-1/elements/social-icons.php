...
if(true == ampforwp_get_setting('ampforwp-social-share')){ ?>
	<div class="ampforwp-social-icons">
		...
		<?php if($redux_builder_amp['enable-single-line-share'] == true)  { ?>
			<a title="line share" <?php ampforwp_nofollow_social_links(); ?> href="http://line.me/R/msg/text/?<?php echo esc_url($amp_permalink); ?>">
				<div class="amp-social-icon custom-amp-socialsharing-line" aria-label="line share">
