...
if(true == ampforwp_get_setting('ampforwp-social-share')){ ?>
	<div class="ampforwp-so-i">
		...
		<?php if(ampforwp_get_setting('enable-single-facebook-share') == true)  { ?>
			<amp-social-share type="facebook" data-param-app_id="<?php echo esc_attr(ampforwp_get_setting('amp-facebook-app-id')); ?>" width="50" height="28" <?php ampforwp_rel_attributes_social_links(); ?>></amp-social-share>
		<?php } ?>
	    ...
	    $data_param_data = str_replace('@', '', $data_param_data);?>
			...
			></amp-social-share>
		<?php } ?>
		<?php if(ampforwp_get_setting('enable-single-email-share') == true)  { ?>
		...
		<?php } ?>
		<?php if(ampforwp_get_setting('enable-single-pinterest-share') == true)  { ?>
		...
		<?php } ?>
		<?php if(ampforwp_get_setting('enable-single-linkedin-share') == true)  { ?>
		...
		<?php } ?>
		<?php if(ampforwp_get_setting('enable-single-whatsapp-share') == true)  { ?>
		...
		<?php } ?>
		<?php if(ampforwp_get_setting('enable-single-whatsapp-group-share') == true)  { ?>
			<a title="whatsapp group" <?php ampforwp_rel_attributes_social_links(); ?> href="<?php echo esc_url(ampforwp_get_setting('whatsapp-group-link'))?>" aria-label="whatsapp share">
				<div class="a-so-i">
				    <amp-img src="data:image/svg+xml;utf8;base64," width="50" height="20" />
			    </div>
			</a>
		...
		<?php } ?>
		<?php if(ampforwp_get_setting('enable-single-vk-share') == true)  { ?>
