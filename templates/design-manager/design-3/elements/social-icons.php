    ...
    <i class="icono-share"></i>
		...
		<?php if ( true == $redux_builder_amp['enable-single-facebook-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="facebook share" <?php ampforwp_nofollow_social_links(); ?> href="https://www.facebook.com/dialog/share?app_id=<?php echo esc_attr($redux_builder_amp['amp-facebook-app-id']); ?>&display=page&href=<?php echo esc_url($amp_permalink); ?>" class="a-so-i-rounded a-so-facebook" aria-label="facebook share">
		...
		<?php if(ampforwp_get_setting('enable-single-facebook-share-messenger')){?>
			<div class="ampforwp-custom-social">
				<a title="facebook share messenger" <?php ampforwp_nofollow_social_links(); ?> href="fb-messenger://share/?link=<?php echo esc_url($amp_permalink_fb_messenger); ?>" class="a-so-facebook-messenger a-so-icon-rounded" aria-label="facebook share messenger">
	    ...
	    $data_param_data = str_replace('@', '', $data_param_data);?>
			<div class="ampforwp-custom-social">
				<a title="twitter share" <?php ampforwp_nofollow_social_links(); ?> href="https://twitter.com/intent/tweet?url=<?php echo esc_url($twitter_amp_permalink); ?>&text=<?php echo esc_attr(rawurlencode( get_the_title() )); ?>&via=<?php echo esc_attr($data_param_data); ?>" class="a-so-i-rounded a-so-twitter" aria-label="twitter share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-email-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="mailto" <?php ampforwp_nofollow_social_links(); ?> href="mailto:?subject=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>&body=<?php echo esc_url($amp_permalink); ?>" class="a-so-i-rounded a-so-email" aria-label="mailto share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-pinterest-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="pinterest share" <?php ampforwp_nofollow_social_links(); ?> href="https://pinterest.com/pin/create/bookmarklet/?media=<?php echo esc_url($image); ?>&url=<?php echo esc_url($amp_permalink); ?>&description=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="a-so-i-rounded a-so-pinterest" aria-label="pinterest share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-linkedin-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="linkedin share" <?php ampforwp_nofollow_social_links(); ?> href="https://www.linkedin.com/shareArticle?url=<?php esc_url(the_permalink()); ?>&title=<?php the_title(); ?>" class="a-so-i-rounded a-so-linkedin" target="_blank" aria-label="linkedin share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-line-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="line share" <?php ampforwp_nofollow_social_links(); ?> class="a-so-line a-so-icon-rounded" href="http://line.me/R/msg/text/?<?php echo esc_url($amp_permalink); ?>" aria-label="line share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-vk-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="vkontakte share" <?php ampforwp_nofollow_social_links(); ?> href="http://vk.com/share.php?url=<?php echo esc_url($amp_permalink); ?>" class="a-so-i-rounded a-so-vk" target="_blank" aria-label="vkontakte share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-reddit-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="reddit share" <?php ampforwp_nofollow_social_links(); ?> href="https://reddit.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="a-so-i-rounded a-so-reddit" aria-label="reddit share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-tumblr-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="tumblr share" <?php ampforwp_nofollow_social_links(); ?> href="https://www.tumblr.com/widgets/share/tool?canonicalUrl=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>&caption=<?php echo esc_attr(get_the_excerpt()); ?>" target="_blank" class="a-so-i-rounded a-so-tumblr" aria-label="tumblr share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-telegram-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="telegram share" <?php ampforwp_nofollow_social_links(); ?> href="https://telegram.me/share/url?url=<?php echo esc_url($amp_permalink); ?>&text=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="a-so-i-rounded a-so-telegram" aria-label="telegram share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-stumbleupon-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="stumbleupon share" <?php ampforwp_nofollow_social_links(); ?> href="http://www.stumbleupon.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="a-so-i-rounded a-so-stumbleupon" aria-label="stumbleupon share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-wechat-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="wechat share" <?php ampforwp_nofollow_social_links(); ?> href="http://api.addthis.com/oexchange/0.8/forward/wechat/offer?url=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="a-so-i-rounded a-so-wechat" aria-label="wechat share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-viber-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="viber share" <?php ampforwp_nofollow_social_links(); ?> href="viber://forward?text=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="a-so-i-rounded a-so-viber" aria-label="viber share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-hatena-bookmarks'] ) { ?>
			<a title="hatena share" <?php ampforwp_nofollow_social_links(); ?> href="http://b.hatena.ne.jp/entry/<?php echo esc_url($amp_permalink); ?>" target="_blank" aria-label="hatena share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-pocket-share'] ) { ?>
			<a title="pocket share" <?php ampforwp_nofollow_social_links(); ?> href="https://getpocket.com/save?url=<?php echo esc_url($amp_permalink); ?>" target="_blank" aria-label="pocket share">
		...
		<?php if ( true == ampforwp_get_setting('enable-single-mewe-share') ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="mewe share" <?php ampforwp_nofollow_social_links(); ?> href="https://mewe.com/share?link=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="a-so-i-rounded a-so-mewe" aria-label="mewe share">
		...
		<?php if ( true == ampforwp_get_setting('enable-single-flipboard-share') ) { ?>
			<a title="flipboard share" <?php ampforwp_nofollow_social_links(); ?> href="https://share.flipboard.com/bookmarklet/popout?v=<?php echo esc_html(get_the_title(ampforwp_get_the_ID())); ?>&url=<?php echo urlencode(esc_url($amp_permalink)); ?>" target="_blank" class="a-so-i-rounded a-so-flipboard" aria-label="flipboard share">
