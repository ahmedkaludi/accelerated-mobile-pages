...
.cntn-wrp p:first-of-type::first-letter,.cntn-wrp h1:first-of-type::first-letter, .cntn-wrp span:first-of-type::first-letter, .cntn-wrp div:first-of-type::first-letter{
    float: left;
    font-size: 75px;
    line-height: 1;
    padding-right: 8px;
