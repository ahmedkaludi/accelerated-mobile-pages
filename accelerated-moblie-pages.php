...
function ampforwp_add_plugin_meta_links($meta_fields, $file) {
    if ( plugin_basename(__FILE__) == $file ) {
      ...
      $meta_fields[] = "<a href='" . esc_url($plugin_url) . "/reviews#new-post' target='_blank' title='" . esc_html__('Rate', 'accelerated-mobile-pages') . "'>
        ...
        . "</i></a>";      
      echo "<style>"
        . ".ampforwp-rate-stars{display:inline-block;color:#ffb900;position:relative;top:3px;}"
        . ".ampforwp-rate-stars svg{fill:#ffb900;}"
        . ".ampforwp-rate-stars svg:hover{fill:#ffb900}"
        . ".ampforwp-rate-stars svg:hover ~ svg{fill:none;}"
        . "</style>";
    }
