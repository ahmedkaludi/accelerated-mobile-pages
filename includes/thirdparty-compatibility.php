...
function ampforwp_compatibility_for_opensea_callback($matches){
		 ...
		 if ( is_array( $response ) && ! is_wp_error( $response ) ) {
			...
			<div class='card-front'>
			  <div class='asset-image-container'>
				<a target='_blank' href='".$nft_data['permalink']."'>
				  <div class='asset-image' style='background-image: url(&quot;".$nft_data['image_url']."&quot;); background-size: contain;'></div>
				</a>
			  </div>
				<div class='asset-details-container'>
				  <div class='asset-detail'>
					<div class='asset-detail-type'>
					  <a class='asset-link' target='_blank' href='https://opensea.io/assets/".$nft_data['collection']['slug']."'>
					  <img alt='' src='".$nft_data['asset_contract']['image_url']."'>
            		  <p><!---->".$nft_data['asset_contract']['name']."<!----></p>
					  </a>
					</div>
				  </div>
				  <div class='spacer'></div>
				  <div class='asset-detail-name'>
					<a class='asset-link' target='_blank' href='".$nft_data['permalink']."'>".$nft_data['name']."</a>
				  </div>
				  
				<a class='asset-link' target='_blank' href='".$nft_data['permalink']."'>
			...
			<div class='asset-action-buy'>
			  <button>
				<a class='asset-link' target='_blank' href='".$nft_data['permalink']."'> buy this item > </a>
			  </button>
				  </div>
				</div>
		  </div>
	...
	if(isset($response['response']['code']) && $response['response']['message'] ){
		$default_return = '<center><small> Opensea Error - '.$response['response']['code'].' : '.$response['response']['message'].'</small></center>' ;
	}
