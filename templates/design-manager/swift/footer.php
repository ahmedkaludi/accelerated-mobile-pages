...
<div class="s_stk ss-ic">
	<ul>
		...
		<?php if(ampforwp_get_setting('enable-single-whatsapp-share')){
								...
								?>
		<li>
			<a title="whatsapp share" class="s_wp" target="_blank" <?php ampforwp_rel_attributes_social_links(); ?> href="https://api.whatsapp.com/send?text=<?php echo esc_url($amp_permalink); ?>" data-action="share/whatsapp/share"><?php echo $whatsapp_icon; ?></a>
		</li>
		<?php } ?>
		...
		<?php if(ampforwp_get_setting('enable-single-odnoklassniki-share')){
								...
								?>
		<li>
			<a title="odnoklassniki share" class="s_od" target="_blank" <?php ampforwp_rel_attributes_social_links(); ?> href="https://ok.ru/dk?st.cmd=addShare&st._surl=<?php echo esc_url($amp_permalink); ?>"><?php echo $odnoklassniki_icon; ?></a>
		</li>
		<?php } ?>
