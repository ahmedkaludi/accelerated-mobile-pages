...
<i class="icono-share"></i>
		...
		<?php if ( true == $redux_builder_amp['enable-single-facebook-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="facebook share" href="https://www.facebook.com/dialog/share?app_id=<?php echo esc_attr($redux_builder_amp['amp-facebook-app-id']); ?>&display=page&href=<?php echo esc_url($amp_permalink); ?>" class="amp-social-icon-rounded amp-social-facebook">
		...
		<?php if(ampforwp_get_setting('enable-single-facebook-share-messenger')){?>
			<div class="ampforwp-custom-social">
				<a title="facebook share messenger" href="fb-messenger://share/?link=<?php echo esc_url($amp_permalink); ?>&app_id=<?php echo esc_attr($facebook_app_id) ?>" class="amp-social-facebook-messenger">
      ...
      $data_param_data = $redux_builder_amp['enable-single-twitter-share-handle']; ?>
			<div class="ampforwp-custom-social">
				<a title="twitter share" href="https://twitter.com/intent/tweet?url=<?php echo esc_url($amp_permalink); ?>&text=<?php echo esc_attr(rawurlencode( get_the_title() )); ?>&via=<?php echo esc_attr($data_param_data); ?>" class="amp-social-icon-rounded amp-social-twitter">
		...
		<?php if ( true == $redux_builder_amp['enable-single-gplus-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="google plus share" href="https://plus.google.com/share?url=<?php echo esc_url($amp_permalink); ?>" class="amp-social-icon-rounded amp-social-gplus">
		...
		<?php if ( true == $redux_builder_amp['enable-single-email-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="mailto" href="mailto:?subject=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>&body=<?php echo esc_url($amp_permalink); ?>" class="amp-social-icon-rounded amp-social-email">
		...
		<?php if ( true == $redux_builder_amp['enable-single-pinterest-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="pinterest share" href="https://pinterest.com/pin/create/bookmarklet/?media=<?php echo esc_url($image); ?>&url=<?php echo esc_url($amp_permalink); ?>&description=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-pinterest">
		...
		<?php if ( true == $redux_builder_amp['enable-single-linkedin-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="linkedin share" href="https://www.linkedin.com/shareArticle?url=<?php esc_url($amp_permalink); ?>&title=<?php the_title(); ?>" class="amp-social-icon-rounded amp-social-linkedin" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-whatsapp-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="whatsapp share" href="whatsapp://send?text=<?php echo esc_url($amp_permalink);?>" class="amp-social-icon-rounded amp-social-whatsapp">
		...
		<?php if ( true == $redux_builder_amp['enable-single-line-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="line share" class="amp-social-line amp-social-icon-rounded" href="http://line.me/R/msg/text/?<?php echo esc_url($amp_permalink); ?>">
		...
		<?php if ( true == $redux_builder_amp['enable-single-odnoklassniki-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="odnoklassniki share" href="https://ok.ru/dk?st.cmd=addShare&st._surl=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-odnoklassniki">
		...
		<?php if ( true == $redux_builder_amp['enable-single-reddit-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="reddit share" href="https://reddit.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-reddit">
		...
		<?php if ( true == $redux_builder_amp['enable-single-tumblr-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="tumblr share" href="https://www.tumblr.com/widgets/share/tool?canonicalUrl=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>&caption=<?php echo esc_attr(get_the_excerpt()); ?>" target="_blank" class="amp-social-icon-rounded amp-social-tumblr">
		...
		<?php if ( true == $redux_builder_amp['enable-single-digg-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="digg share" href="http://digg.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-digg">
		...
		<?php if ( true == $redux_builder_amp['enable-single-stumbleupon-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="stumbleupon share" href="http://www.stumbleupon.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-stumbleupon">
		...
		<?php if ( true == $redux_builder_amp['enable-single-wechat-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="wechat share" href="http://api.addthis.com/oexchange/0.8/forward/wechat/offer?url=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-wechat">
		...
		<?php if ( true == $redux_builder_amp['enable-single-viber-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="viber share" href="viber://forward?text=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-viber">
