...
h2.amp-wp-title , .amp-wp-post-content p{ margin: 0 0 0 5px; word-break: break-all;}
/* For Excerpt */
...
/* Footer */
#footer{ background : <?php echo $redux_builder_amp['ampforwp-footer-background-color-2']['color'] ?>; font-size: 13px; text-align: center; letter-spacing: 0.2px; padding: 20px 0; }
...
.the_content p{ margin-top: 5px; color: #333; font-size: 15px; line-height: 26px; margin-bottom: 15px;word-break: break-all; }
