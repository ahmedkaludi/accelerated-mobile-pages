									...
									<footer class="comment-meta">
									   <?php if($comment_author_img_url){ ?>
										...
										<div class="comment-author vcard">
											<?php  printf(esc_html__('<b class="fn">%s</b> <span class="says">'.ampforwp_translation($redux_builder_amp['amp-translator-says-text'],'says').':</span>'), esc_url(get_comment_author_link())) ?>
										</div>
										<!-- .comment-author -->
