...
function amp_loop_image( $data=array() ) {
	...
	if (ampforwp_has_post_thumbnail()  ) {
		...
		if ( isset($data['image_crop']) && $data['image_crop'] != "" ) {
			...
			$thumbnail_modify = array(
		       'thumb_url'=>$thumb_url,
		        'width'=>$width,
		        'height'=> $height
		        );
			$thumbnail_modify = apply_filters('ampforwp_modify_thumb_url_array', $thumbnail_modify);
			$thumb_url = $thumbnail_modify['thumb_url'];
			$width = $thumbnail_modify['width'];
			$height = $thumbnail_modify['height'];
