  ...
  Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
           ...
           array(
               ...
               'content'   => "<span class='button button-primary button-small' id='ampforwp-clear-clearcss-data' target='_blank'  data-nonce='".wp_create_nonce( 'ampforwp_clear_tree_shaking')."'><i class='el el-check-empty'></i> Clear CSS</span><span id='ampforwp-clear-clcss-msg' ></span>",
               'tooltip-subtitle' => esc_html__('To clear cached CSS', 'amp-pagebuilder-compatibility'),
               'full_width' => false,
