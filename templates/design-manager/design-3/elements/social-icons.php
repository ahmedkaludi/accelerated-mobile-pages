...
<i class="icono-share"></i>
    	<?php if ( true == ampforwp_get_setting('ampforwp-facebook-like-button') ){
    		if( false == ampforwp_get_setting('ampforwp-facebook-like-data-action') ) {
				$facebook_like_url = '';
				$facebook_like_url = $amp_permalink;
				if ( $facebook_like_url ) { ?>
					<amp-facebook-like width=90 height=28 style="margin-bottom: 8px"
					 	layout="fixed"
					 	data-size="large"
      ...
      $data_param_data = $redux_builder_amp['enable-single-twitter-share-handle']; ?>
			<div class="ampforwp-custom-social">
				<a title="twitter share" <?php ampforwp_nofollow_social_links(); ?> href="https://twitter.com/intent/tweet?url=<?php echo esc_url($amp_permalink); ?>&text=<?php echo esc_attr(rawurlencode( get_the_title() )); ?>&via=<?php echo esc_attr($data_param_data); ?>" class="amp-social-icon-rounded amp-social-twitter">
		...
		<?php if ( true == $redux_builder_amp['enable-single-gplus-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="google plus share" <?php ampforwp_nofollow_social_links(); ?> href="https://plus.google.com/share?url=<?php echo esc_url($amp_permalink); ?>" class="amp-social-icon-rounded amp-social-gplus">
		...
		<?php if ( true == $redux_builder_amp['enable-single-email-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="mailto" <?php ampforwp_nofollow_social_links(); ?> href="mailto:?subject=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>&body=<?php echo esc_url($amp_permalink); ?>" class="amp-social-icon-rounded amp-social-email">
		...
		<?php if ( true == $redux_builder_amp['enable-single-pinterest-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="pinterest share" <?php ampforwp_nofollow_social_links(); ?> href="https://pinterest.com/pin/create/bookmarklet/?media=<?php echo esc_url($image); ?>&url=<?php echo esc_url($amp_permalink); ?>&description=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-pinterest">
		...
		<?php if ( true == $redux_builder_amp['enable-single-linkedin-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="linkedin share" <?php ampforwp_nofollow_social_links(); ?> href="https://www.linkedin.com/shareArticle?url=<?php esc_url($amp_permalink); ?>&title=<?php the_title(); ?>" class="amp-social-icon-rounded amp-social-linkedin" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-line-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="line share" class="amp-social-line amp-social-icon-rounded" <?php ampforwp_nofollow_social_links(); ?> href="http://line.me/R/msg/text/?<?php echo esc_url($amp_permalink); ?>">
		...
		<?php if ( true == $redux_builder_amp['enable-single-vk-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="vkontakte share" <?php ampforwp_nofollow_social_links(); ?> href="http://vk.com/share.php?url=<?php echo esc_url($amp_permalink); ?>" class="amp-social-icon-rounded amp-social-vk" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-odnoklassniki-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="odnoklassniki share" <?php ampforwp_nofollow_social_links(); ?> href="https://ok.ru/dk?st.cmd=addShare&st._surl=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-odnoklassniki">
		...
		<?php if ( true == $redux_builder_amp['enable-single-reddit-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="reddit share" <?php ampforwp_nofollow_social_links(); ?> href="https://reddit.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-reddit">
		...
		<?php if ( true == $redux_builder_amp['enable-single-telegram-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="telegram share" <?php ampforwp_nofollow_social_links(); ?> href="https://telegram.me/share/url?url=<?php echo esc_url($amp_permalink); ?>&text=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-telegram">
		...
		<?php if ( true == $redux_builder_amp['enable-single-digg-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="digg share" <?php ampforwp_nofollow_social_links(); ?> href="http://digg.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-digg">
		...
		<?php if ( true == $redux_builder_amp['enable-single-stumbleupon-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="stumbleupon share" <?php ampforwp_nofollow_social_links(); ?> href="http://www.stumbleupon.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-stumbleupon">
		...
		<?php if ( true == $redux_builder_amp['enable-single-wechat-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="wechat share" <?php ampforwp_nofollow_social_links(); ?> href="http://api.addthis.com/oexchange/0.8/forward/wechat/offer?url=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-wechat">
		...
		<?php if ( true == $redux_builder_amp['enable-single-viber-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="viber share" <?php ampforwp_nofollow_social_links(); ?> href="viber://forward?text=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-viber">
