...
function ampforwp_enable_plugins_modules($plugins)
{
    ...
    {
            $is_downloaded = mm_plugin_download($plugin['path'], $args['path'].$plugin['name'].'.zip');
            if($is_downloaded){
...
add_action('wp_ajax_ampforwp_enable_pwa_module', 'ampforwp_enable_pwa_module');
function ampforwp_enable_pwa_module(){
    $plugins = array();
    $redirectSettingsUrl = '';
    ...
    switch($currentActivateModule){
        case 'pwa': 
            ...
            $redirectSettingsUrl = admin_url('admin.php?page=pwaforwp');
        break;
        case 'structure_data':
            $plugins[] = array(
            ...
            $redirectSettingsUrl = admin_url('admin.php?page=structured_data_options&tab=general');
        break;
        default:
            $plugins = array();
        break;
