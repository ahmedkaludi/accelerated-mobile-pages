...
if(true == ampforwp_get_setting('ampforwp-social-share')){ ?>
	<div class="amp-wp-content post-pagination-meta ampforwp-social-icons-wrapper ampforwp-so-i">
		...
		<?php if($redux_builder_amp['enable-single-whatsapp-share'] == true)  { ?>
			<a title="whatsapp share" <?php ampforwp_rel_attributes_social_links(); ?> href="https://api.whatsapp.com/send?text=<?php echo esc_url($amp_permalink); ?>" aria-label="whatsapp share">
				<div class="a-so-i">
		...
		<?php if($redux_builder_amp['enable-single-odnoklassniki-share'] == true)  { ?>
			<a title="odnoklassniki share" <?php ampforwp_rel_attributes_social_links(); ?> href="https://ok.ru/dk?st.cmd=addShare&st._surl=<?php echo esc_url($amp_permalink); ?>" target="_blank" aria-label="odnoklassniki share">
