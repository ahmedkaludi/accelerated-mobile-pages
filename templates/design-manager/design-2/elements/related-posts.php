							...
							<?php if ( ampforwp_has_post_thumbnail() ) {
				                ...
				                <div class="related_link">
				                    ...
				                    <?php if ( isset($redux_builder_amp['ampforwp-single-related-posts-excerpt']) && true == $redux_builder_amp['ampforwp-single-related-posts-excerpt'] ) {
				                    	...
				                    	echo wp_trim_words( strip_shortcodes($content) , $excerpt_length ); ?><br><?php if (true == ampforwp_get_setting('excerpt-option-rp-read-more')){?><br><a class="readmore-rp" href="<?php echo esc_url( $related_post_permalink ); ?>"><?php echo ampforwp_translation(ampforwp_get_setting('amp-translator-read-more'),'Read More') ?></a></p>
				                    <?php } } ?>	
				                </div>
				            </li>
					<?php 
