...
function ampforwp_minify_html_output($content_buffer){
    ...
    if(preg_match('/<a class="(.*?)" a href="(.*?)" title="(.*?)">(.*?)<\/a>/', $content_buffer)){
        $content_buffer = preg_replace('/<a class="(.*?)" a href="(.*?)" title="(.*?)">(.*?)<\/a>/', '<a class="$1" href="$2" title="$3"></a>', $content_buffer);
    }

    if(preg_match('/<a class="(.*?)" a href="(.*?)" class="(.*?)>(.*?)<\/a>/', $content_buffer)){
        $content_buffer = preg_replace('/<a class="(.*?)" a href="(.*?)" class="(.*?)">(.*?)<\/a>/', '<a class="$1" href="$2" class="$3" ></a>', $content_buffer,10);
    }
