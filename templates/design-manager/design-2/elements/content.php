		...
		if($redux_builder_amp['enable-single-next-prev'] && !is_page() ) { ?>
			...
			<div class="amp-wp-content post-pagination-meta">
				<div id="pagination">
					...
					if (!empty( $next_post )) { ?>
						<div class="next">
							<?php $next_text = $next_post->post_title; ?> <a href="<?php echo esc_url(ampforwp_url_controller( get_permalink( $next_post->ID ) )); ?>"><?php echo esc_attr(apply_filters('ampforwp_next_link',$next_text )); ?> &raquo;</a>
						</div>
					<?php }
					...
					if (!empty( $prev_post )) { ?>
						<div class="prev">
							...
							<a href="<?php echo esc_url(ampforwp_url_controller( get_permalink( $prev_post->ID ) )); ?>"> &laquo; <?php echo esc_attr(apply_filters('ampforwp_prev_link',$prev_text )); ?></a>
						</div>
					<?php } ?>
