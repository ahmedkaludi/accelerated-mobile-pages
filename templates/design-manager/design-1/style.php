...
.amp-wp-content,.amp-wp-title-bar div {<?php if ( $content_max_width > 0 && !checkAMPforPageBuilderStatus(ampforwp_get_the_ID()) ) : ?> margin: 0 auto;max-width: <?php echo esc_attr(sprintf( '%dpx', $content_max_width )); ?>; <?php endif; ?> }
