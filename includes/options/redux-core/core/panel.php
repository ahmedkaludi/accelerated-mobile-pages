        ...
        class reduxCorePanel {
            ...
            private function panel_template() {
                ...
                <div class="ampforwp-ocassional-pop-up-contents">
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/512/2349/2349820.png" class="ampforwp-promotion-surprise-icon" />
                    <p class="ampforwp-ocassional-pop-up-headline">'.esc_html('40% OFF on', 'accelerated-mobile-pages').'<span>'.esc_html_e('Easy TOC PRO', 'accelerated-mobile-pages').'</span></p>
