...
<div class="sp sgl">
	<?php if(!checkAMPforPageBuilderStatus(get_the_ID())){ ?>
		<div class="cntr">
			...
			<div class="anm-ptdt">
				<?php if( true == ampforwp_get_setting('amp-author-name') ) { ?>
		            <div class="apt-athr">
		            	<span class="apt-athr-tx">
		            		<?php echo ampforwp_translation( ampforwp_get_setting('amp-translator-by-text'), 'By' ); ?></span>
		            	<?php amp_author_box( array('author_pub_name'=>true,'author_info'=>true) ); ?>	
		            </div>
		         <?php } 
	            if( true == ampforwp_get_setting('swift-date') ) { ?>
		            <div class="apt-post-date">
		...
		<?php } // left sidebar ends ?>
			...
			<?php
				if ( ampforwp_get_setting('swift-featued-image') && (ampforwp_has_post_thumbnail() || ampforwp_get_setting('ampforwp-featured-video') == true && !empty(ampforwp_get_setting('ampforwp-featured-video-metakey'))) ) { ?>
				...
				<div class="sp-left">
					<?php if( !checkAMPforPageBuilderStatus(get_the_ID()) ) { ?>
						...
						?>
							<div class="sf-img">
								<?php 
								$featured_video = amp_featured_video();
...
<div class="sp sgl-7">
	<div class="cntr">
		...
		<?php } // AMP Pagebuilder Condition Ends Here?>
		<div class="sgl7-artl">
			<div class="sgl7-left">
				<?php if( !checkAMPforPageBuilderStatus(get_the_ID()) ) { 
				if(ampforwp_get_setting('ampforwp-featured-video') == true && !empty(ampforwp_get_setting('ampforwp-featured-video-metakey'))){
					?>
					<div class="sf-img">
						<?php $featured_video = amp_featured_video();
						if(empty($featured_video)){
							amp_featured_image();
						}else{
							echo $featured_video;
				...
				} // AMP Pagebuilder Condition Ends Here?>
				<div class="cntn-wrp artl-cnt">
					<?php
