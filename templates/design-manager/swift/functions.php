...
<div class="ss-ic">
						...
						<ul>
							...
							<li>
								<a title="facebook share messenger" class="s_fb_ms" target="_blank" <?php ampforwp_nofollow_social_links(); ?> href="fb-messenger://share/?link=<?php echo esc_url($amp_permalink_fb_messenger); ?>"></a>
							</li>
							<?php } ?>
							<?php 
							$data_param = '';
		...
		<?php } ?>
							...
							<li>
								<a title="viber share" class="s_vb" target="_blank" <?php ampforwp_nofollow_social_links(); ?> href="viber://forward?text=<?php echo esc_url($amp_permalink); ?>"></a>
							</li>
							<?php } ?>
						...
						<?php if ( true == ampforwp_get_setting('enable-single-flipboard-share')){?>
							<li>
								<a title="flipboard share" class="s_flipboard" target="_blank" <?php ampforwp_nofollow_social_links(); ?> href="https://share.flipboard.com/bookmarklet/popout?v=<?php echo esc_html(get_the_title()); ?>&url=<?php echo urlencode(esc_url($amp_permalink)); ?>">
