...
//Require common features
require_once AMPFORWP_PLUGIN_DIR."includes/features/advertisement/advertisement-admin-opt.php";
require_once AMPFORWP_PLUGIN_DIR."includes/features/performance/performance-admin-opt.php";
require_once AMPFORWP_PLUGIN_DIR."includes/features/analytics/analytics-admin-opt.php";
require_once AMPFORWP_PLUGIN_DIR."includes/features/structure-data/structure-data-admin-opt.php";
require_once AMPFORWP_PLUGIN_DIR."includes/features/notice-bar/notice-bar-admin-opt.php";
require_once AMPFORWP_PLUGIN_DIR."includes/features/push-notification/push-notification-admin-opt.php";
require_once AMPFORWP_PLUGIN_DIR."includes/features/contact-form/contact-form-admin-opt.php";
require_once AMPFORWP_PLUGIN_DIR."includes/features/comments/comments-admin-opt.php";
