	...
	<div <?php if(!checkAMPforPageBuilderStatus(get_the_ID())){ ?>class="cntr"<?php } ?>>
       ...
       <div class="pg">
			<div class="cntn-wrp">
				...
				<?php } else { ?>
					<?php if( ampforwp_get_setting('page_sidebar') == '1' && !checkAMPforPageBuilderStatus(get_the_ID()) ){ ?>
			...
			if( is_page() && isset($redux_builder_amp['ampforwp-page-social']) && $redux_builder_amp['ampforwp-page-social'] ) { ?>
				<div class="ss-ic">
					...
					<ul>
						...
						<li>
							<a title="twitter share" class="s_tw" target="_blank" href="https://twitter.com/intent/tweet?url=<?php the_permalink(); ?>&text=<?php echo esc_attr(get_the_title()); ?>">
							</a>
						</li>
						<?php } ?>
