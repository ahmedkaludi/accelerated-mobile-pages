...
.amp-menu li.menu-item-has-children ul{display:none;margin:0;background:#666;position:relative;padding: 10px 0px 10px 20px;}
.amp-menu li.menu-item-has-children .sub-menu li a:before{
    content: '\25b8';
    position: absolute;
    left: 4px;
    font-size: 10px;
...
.amp-menu .toggle:after{content:'\25be';position:absolute;padding: 12px 20px 10px 30px;right:0;font-size:13px;color:#ccc;top:0;z-index:10000;line-height:1}
...
.amp-social-facebook{background:#3b5998}.amp-fb-chat{background:#0084ff}.amp-social-twitter{background:#1da1f2}.amp-social-gplus{background:#dd4b39}.amp-social-email{background:#000000}.amp-social-pinterest{background:#bd081c}.amp-social-linkedin{background:#0077b5}.amp-social-whatsapp{background:#5cbe4a}
