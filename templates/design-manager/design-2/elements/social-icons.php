...
if(true == ampforwp_get_setting('ampforwp-social-share')){ ?>
	<div class="amp-wp-content post-pagination-meta ampforwp-social-icons-wrapper ampforwp-so-i">
		...
		<?php if($redux_builder_amp['enable-single-odnoklassniki-share'] == true)  { 
			...
			?>
			<a title="odnoklassniki share" <?php ampforwp_rel_attributes_social_links(); ?> href="https://connect.ok.ru/offer?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars(get_the_title())); ?>&imageUrl=<?php echo esc_url($feature_img); ?>" target="_blank" aria-label="odnoklassniki share">
