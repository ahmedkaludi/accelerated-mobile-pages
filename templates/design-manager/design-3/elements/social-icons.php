...
<div class="amp-wp-content ampforwp-social-icons-wrapper ampforwp-so-i">
    <i class="icono-share"></i>
		...
		<?php if(ampforwp_get_setting('enable-single-facebook-share-messenger')){?>
			<div class="ampforwp-custom-social">
				<a title="facebook share messenger" <?php ampforwp_nofollow_social_links(); ?> href="fb-messenger://share/?link=<?php echo esc_url($amp_permalink_fb_messenger); ?>" class="a-so-facebook-messenger a-so-i-rounded" aria-label="facebook share messenger">
		...
		<?php if ( true == $redux_builder_amp['enable-single-line-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="line share" <?php ampforwp_nofollow_social_links(); ?> class="a-so-line a-so-i-rounded" href="http://line.me/R/msg/text/?<?php echo esc_url($amp_permalink); ?>" aria-label="line share">
