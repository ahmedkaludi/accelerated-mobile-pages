    ...
    if ( !is_front_page() && !ampforwp_polylang_front_page() ) {
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() && !is_author() ) {
            ...
            // Else if post is in a custom taxonomy
                ...
                echo '<li class="item-cat item-cat-' . esc_attr($cat_id) . ' item-cat-' . $cat_nicename . '"><a class="bread-cat bread-cat-' . esc_attr($cat_id) . ' bread-cat-' . esc_attr($cat_nicename) . '" href="' . ampforwp_url_controller( $cat_link, $archive_non_amp ) . '" title="' . esc_attr($cat_name) . '">' . esc_attr($cat_name) . '</a></li>';                
            }  
