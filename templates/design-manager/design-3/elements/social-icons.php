...
<div class="amp-wp-content ampforwp-social-icons-wrapper ampforwp-social-icons">
    <i class="icono-share"></i>
		...
		<?php if(ampforwp_get_setting('enable-single-facebook-share-messenger')){?>
			<div class="ampforwp-custom-social">
				<a title="facebook share messenger" <?php ampforwp_nofollow_social_links(); ?> href="fb-messenger://share/?link=<?php echo esc_url($amp_permalink_fb_messenger); ?>" class="amp-social-facebook-messenger amp-social-icon-rounded" aria-label="facebook share messenger">
		...
		<?php } 
			...
			<div class="ampforwp-custom-social">
				<a title="twitter share" <?php ampforwp_nofollow_social_links(); ?> href="<?php echo esc_url($twitter_share_url); ?>" class="amp-social-icon-rounded amp-social-twitter" aria-label="twitter share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-pinterest-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="pinterest share" <?php ampforwp_nofollow_social_links(); ?> href="https://pinterest.com/pin/create/bookmarklet/?media=<?php echo esc_url($image); ?>&url=<?php echo esc_url($amp_permalink); ?>&description=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-pinterest"  aria-label="pinterest share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-linkedin-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="linkedin share" <?php ampforwp_nofollow_social_links(); ?> href="https://www.linkedin.com/shareArticle?url=<?php esc_url(the_permalink()); ?>&title=<?php the_title(); ?>" class="amp-social-icon-rounded amp-social-linkedin" target="_blank" aria-label="linkedin share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-whatsapp-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="whatsapp share" <?php ampforwp_nofollow_social_links(); ?> href="https://api.whatsapp.com/send?text=<?php echo esc_url($amp_permalink);?>" class="amp-social-icon-rounded amp-social-whatsapp" aria-label="whatsapp share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-line-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="line share" <?php ampforwp_nofollow_social_links(); ?> class="amp-social-line amp-social-icon-rounded" href="http://line.me/R/msg/text/?<?php echo esc_url($amp_permalink); ?>" aria-label="line share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-vk-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="vkontakte share" <?php ampforwp_nofollow_social_links(); ?> href="http://vk.com/share.php?url=<?php echo esc_url($amp_permalink); ?>" class="amp-social-icon-rounded amp-social-vk" target="_blank" aria-label="vkontakte share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-odnoklassniki-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="odnoklassniki share" <?php ampforwp_nofollow_social_links(); ?> href="https://ok.ru/dk?st.cmd=addShare&st._surl=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-odnoklassniki" aria-label="odnoklassniki share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-reddit-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="reddit share" <?php ampforwp_nofollow_social_links(); ?> href="https://reddit.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-reddit"  aria-label="reddit share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-telegram-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="telegram share" <?php ampforwp_nofollow_social_links(); ?> href="https://telegram.me/share/url?url=<?php echo esc_url($amp_permalink); ?>&text=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank" class="amp-social-icon-rounded amp-social-telegram" aria-label="telegram share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-wechat-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="wechat share" <?php ampforwp_nofollow_social_links(); ?> href="http://api.addthis.com/oexchange/0.8/forward/wechat/offer?url=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-wechat" aria-label="wechat share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-viber-share'] ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="viber share" <?php ampforwp_nofollow_social_links(); ?> href="viber://forward?text=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-viber" aria-label="viber share">
		...
		<?php if ( true == ampforwp_get_setting('enable-single-mewe-share') ) { ?>
			<div class="ampforwp-custom-social"> 
				<a title="mewe share" <?php ampforwp_nofollow_social_links(); ?> href="https://mewe.com/share?link=<?php echo esc_url($amp_permalink); ?>" target="_blank" class="amp-social-icon-rounded amp-social-mewe" aria-label="mewe share">
		...
		<?php if ( true == ampforwp_get_setting('enable-single-flipboard-share') ) { ?>
			<a title="flipboard share" <?php ampforwp_nofollow_social_links(); ?> href="https://share.flipboard.com/bookmarklet/popout?v=<?php echo esc_html(get_the_title(ampforwp_get_the_ID())); ?>&url=<?php echo urlencode(esc_url($amp_permalink)); ?>" target="_blank" class="amp-social-icon-rounded amp-social-flipboard" aria-label="flipboard share">
