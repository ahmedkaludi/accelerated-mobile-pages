...
function ampforwp_modify_amp_activatation_link( $actions, $plugin_file )  {
	...
	if (  $plugin == $plugin_file  ) {
		...
		$a = '<span style="cursor:pointer;color:#0089c8" class="warning_activate_amp" onclick="alert(\'AMP is already bundled with AMPforWP to avoid conflicts.\')">Activate</span>';
