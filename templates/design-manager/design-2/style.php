...
/* Footer */
#footer{ background : <?php echo $redux_builder_amp['ampforwp-footer-background-color']['color'] ?>; font-size: 13px; text-align: center; letter-spacing: 0.2px; padding: 20px 0; }
