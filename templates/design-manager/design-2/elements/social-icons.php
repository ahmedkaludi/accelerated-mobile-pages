...
<?php do_action('ampforwp_before_social_icons_hook',$this); ?>
	<div class="amp-wp-content post-pagination-meta ampforwp-social-icons-wrapper ampforwp-social-icons">
		<?php if( true == ampforwp_get_setting('ampforwp-facebook-like-button') ){if( false == ampforwp_get_setting('ampforwp-facebook-like-data-action')) {
			$facebook_like_url = '';
		...
		<?php if($redux_builder_amp['enable-single-facebook-share'] == true)  { ?>
			<amp-social-share type="facebook"    data-param-app_id="<?php echo $redux_builder_amp['amp-facebook-app-id']; ?>" width="50" height="28" <?php ampforwp_nofollow_social_links(); ?> ></amp-social-share>
		<?php } ?>
		...
		<?php if ( true == $redux_builder_amp['enable-single-reddit-share'] ) { ?>
			<a title="reddit share" <?php ampforwp_nofollow_social_links(); ?> href="https://reddit.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-tumblr-share'] ) { ?>
			<a title="tumblr share" <?php ampforwp_nofollow_social_links(); ?> href="https://www.tumblr.com/widgets/share/tool?canonicalUrl=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>&caption=<?php echo esc_attr(get_the_excerpt()); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-telegram-share'] ) { ?>
			<a title="telegram share" <?php ampforwp_nofollow_social_links(); ?> href="https://telegram.me/share/url?url=<?php echo esc_url($amp_permalink); ?>&text=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-digg-share'] ) { ?>
			<a title="digg share" <?php ampforwp_nofollow_social_links(); ?> href="http://digg.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-stumbleupon-share'] ) { ?>
			<a title="stumbleupon share" <?php ampforwp_nofollow_social_links(); ?> href="http://www.stumbleupon.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank">
		...
		<?php if ( true == ampforwp_get_setting('enable-single-mewe-share') ) { ?>
			<a title="mewe share" <?php ampforwp_nofollow_social_links(); ?> href="https://mewe.com/share?link=<?php echo esc_url($amp_permalink); ?>" target="_blank">
		...
		<?php if ( true == ampforwp_get_setting('enable-single-flipboard-share') ) { ?>
			<a title="flipboard share" <?php ampforwp_nofollow_social_links(); ?> href="https://share.flipboard.com/bookmarklet/popout?v=<?php echo esc_html(get_the_title()); ?>&url=<?php echo urlencode(esc_url($amp_permalink)); ?>" target="_blank">
