...
a, a:active, a:visited{ text-decoration: none; color: <?php echo $swift_cs_color; ?>;}
body a:hover{
...
.h-ic a:after, .h-ic a:before{
	<?php if(isset($redux_builder_amp['swift-element-color-control'] ['rgba']) && $redux_builder_amp['swift-element-color-control'] ['rgba']){?>color: <?php echo $redux_builder_amp['swift-element-color-control']['rgba']?>;<?php } ?>}
...
<?php } ?>
<?php if(isset($redux_builder_amp['swift-element-overlay-color-control'] ['rgba']) && $redux_builder_amp['swift-element-overlay-color-control'] ['rgba']){?>color: <?php echo $redux_builder_amp['swift-element-overlay-color-control']['rgba']?>;<?php } ?>line-height: 0;display: block;text-indent: 1px;}
...
<?php } ?>
	display: inline-block;top: 1px;padding: 5px;transform: rotate(270deg);border-radius: 35px;color: <?php echo $redux_builder_amp['swift-element-overlay-color-control']['rgba']?>;}
...
if( is_page() || ampforwp_is_front_page() || ampforwp_polylang_front_page() ){?>
	...
	.amp-comments-wrapper ul li:hover .comment-meta .comment-metadata a{color:<?php echo $swift_cs_color ?>;;}
...
.amp-category span a, .amp-category span{color: <?php echo $swift_cs_color; ?>;font-size: 12px;font-weight: 500;text-transform: uppercase;}
...
<?php } ?>
.ss-ic, .sp-athr, .amp-tags, .sp-lt .post-date{padding-bottom:20px;border-bottom:1px dotted #ccc;}
.shr-txt, .athr-tx, .amp-tags > span:nth-child(1), .amp-related-posts-title, .related-title, .r-pf h3{margin-bottom: 12px;}
.shr-txt, .athr-tx, .r-pf h3, .amp-tags > span:nth-child(1), .amp-related-posts-title, .sp-lt .post-date, .related-title{display: block;}
.shr-txt, .athr-tx, .r-pf h3, .amp-tags > span:nth-child(1), .amp-related-posts-title, .sp-lt .post-date, .related-title{text-transform: uppercase;font-size: 12px;color: #666;font-weight: 400;}
.loop-date, .post-edit-link{display:inline-block;}
.post-date .post-edit-link{color: <?php echo $swift_cs_color; ?>;float: right;}
.post-date .post-edit-link:hover{color: <?php echo $hovercolor; ?>;}
.sp-athr, .amp-tags, .post-date{margin-top:20px;}
.sp-athr .author-details a, .sp-athr .author-details, .amp-tags span a, .amp-tag {font-size: 15px;color: <?php echo $swift_cs_color; ?>;font-weight: 400;line-height: 1.5;}
...
<?php if($redux_builder_amp['rp_design_type'] == '1'){?>
	...
	.has_thumbnail:hover .related_link a{color: <?php echo $swift_cs_color; ?>;}
...
.related_link p{word-wrap: break-word;color: #444;font-size: 13px;line-height: 20px;
...
if( ampforwp_get_setting('single-design-type') == '1' || ampforwp_get_setting('single-design-type') == '4' || ampforwp_get_setting('single-design-type') == '7' ){ 
	...
	.comment-content p{font-size: 14px;color: #333;line-height: 22px;font-weight: 400;margin: 0;}
	.comment-meta amp-img{float:left;margin-right:10px;border-radius:50%;width:40px;}
	<?php  // wordpress-comments-support
	// Comments Pagination ?>
	...
	.cmts-wrap a:hover{color:<?php echo $swift_cs_color ?>;}
	...
	} // ampforwp-disqus-comments ends here 
	//swift Content Heading Sizes Starts ?>
	...
	.artl-cnt .ampforwp-inline-related-post ol li{padding:0;}
	.artl-cnt .ampforwp-inline-related-post ol li::before{content:"";}
	.related_posts .related_link p{color: #444;font-size: 13px;line-height: 20px;letter-spacing: 0.10px;}
	<?php } // In content Related Posts Condition ends Here?>
	@media (max-width: 480px){
		.related_posts ol.clearfix {
...
<?php }
// Sidebar bar color option fields declaration
$sbar_bg_clr           		= ampforwp_get_setting('sidebar-bgcolor','color');
$sbar_heading_clr			= ampforwp_get_setting('sbr-heading-color','color');
$sbar_link_clr				= ampforwp_get_setting('sdr-lnk-color','color');
$sbar_text_clr				= ampforwp_get_setting('sbr-text-color','color');
if(empty($sbar_bg_clr)){
	$sbar_bg_clr ='#f7f7f7';
}
if(empty($sbar_heading_clr)){
	$sbar_heading_clr ='#333333';
}
if(empty($sbar_link_clr)){
	$sbar_link_clr ='#005be2';
}
...
.amp-sidebar a, .amp-sidebar a:hover{
	color: <?php echo ampforwp_sanitize_color($sbar_link_clr); ?>;
}
.amp-sidebar h4{
	color: <?php echo ampforwp_sanitize_color($sbar_heading_clr); ?>;
    font-size: 12px;
    text-transform: uppercase;
    margin-bottom: 2em;
	font-weight: 800;
...
<?php if( checkAMPforPageBuilderStatus(ampforwp_get_the_ID()) && (ampforwp_is_front_page() || is_page()) ) { ?>
...
<?php } // Swift icomoon icons condition ends 
 if(true == ampforwp_get_setting('enable-amp-ads-1')||true == ampforwp_get_setting('enable-amp-ads-2')||true == ampforwp_get_setting('enable-amp-ads-3')||true == ampforwp_get_setting('enable-amp-ads-4')||true == ampforwp_get_setting('enable-amp-ads-5')||true == ampforwp_get_setting('enable-amp-ads-6')){?>
...
<?php if( true == $redux_builder_amp['amp-enable-notifications'] ) {?>
	...
	amp-user-notification button {padding: 8px 10px;background: <?php echo $swift_cs_color; ?>;color: #fff;margin-left: 5px;border: 0;}
	amp-user-notification .amp-not-privacy{color:<?php echo $swift_cs_color; ?>;font-size: 15px;margin-left: 5px;}
...
.arch-psts, .b-w .hmp{padding-left:20px;padding-right:0;}
...
if($header_type == '10'){?>
	...
	.dsk-mnu ul li{
		display: inline-block;
		<?php if( $redux_builder_amp['h10swift_menu_sbfz'] ){ ?>
			font-size:<?php echo $redux_builder_amp['h10swift_menu_sbfz']?>;
		<?php } ?>
		<?php if( $redux_builder_amp['h10swift_menu_fbtwt'] ){ ?>
			font-weight:<?php echo $redux_builder_amp['h10swift_menu_fbtwt']?>;
		<?php } ?>
		margin-right: 30px;
		text-align:center;
	}
	...
	.dsk-mnu .amp-menu li.menu-item-has-children ul { 
		<?php if( $redux_builder_amp['h10swift_submenu_bgcolor']['rgba'] && $redux_builder_amp['h10swift_submenu_sbfz'] ){?>
			background: <?php echo $redux_builder_amp['h10swift_submenu_bgcolor']['rgba']?>;
		<?php }  ?>
	    left: -50%;
	    position: absolute;
	    top: 100%;
	...
	.dsk-mnu .amp-menu li .sub-menu li a{
		<?php if( $redux_builder_amp['h10-drpdwn'] && $redux_builder_amp['h10swift_submenu_sbfz'] ){ ?>
			font-size:<?php echo $redux_builder_amp['h10swift_submenu_sbfz']?>;
		<?php } ?>
		<?php if( $redux_builder_amp['swifth10-background-scheme']['rgba'] && $redux_builder_amp['h10-drpdwn'] ){?>
			color: <?php echo $redux_builder_amp['h10swift_submenu_txtcolor']['rgba']?>;
		<?php }  ?>
		padding:25px 0px;
		box-shadow: 0px 0px 1px 0px <?php echo $redux_builder_amp['h10swift_submenu_bdrcolor']['rgba']?>;
	}
	.dsk-mnu .amp-menu li.menu-item-has-children ul li{
		margin:0;
	}
	...
	.dsk-mnu .amp-menu li.menu-item-has-children > ul:before{
		...
		border-color: transparent transparent <?php echo $redux_builder_amp['h10swift_submenu_bgcolor']['rgba']?> transparent;
		position: absolute;
	    left: 0;
	    right: 0;
	    margin: 0 auto;
...
if( ampforwp_get_setting('single-design-type') == '7' ){ ?>
	...
	.sgl-7 .breadcrumbs{margin-bottom:10px;}
	.sgl-7 .sf-img .wp-caption-text{width:100%;}
	<?php if( ampforwp_get_setting('enable-excerpt-single') ) {?>
	.tl-exc{
		font-size: 16px;
    	line-height: 1.6;
    	font-style: italic;
...
if(ampforwp_get_setting('single-design-type') == '7' && ampforwp_get_setting('ampforwp-swift-recent-posts')=='1' && !checkAMPforPageBuilderStatus(get_the_ID()) ) { ?>
		.sgl7-right{
			...
			<?php if ( ampforwp_get_setting('swift-sidebar') == true && ampforwp_get_setting('gnrl-sidebar') == true ) { ?>
			background: <?php echo ampforwp_sanitize_color($sbar_bg_clr); ?>;
			<?php } ?>
		}
		.r-pf{
