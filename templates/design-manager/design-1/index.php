			 ...
			 if ( $q->have_posts() ) : while ( $q->have_posts() ) : $q->the_post(); ?>
		        <div class="amp-wp-content amp-wp-article-header amp-loop-list">
					...
					<div class="amp-wp-content-loop">
						...
						<span class="amp-wp-commentcount">	<?php  if( true == ampforwp_get_setting('ampforwp-homepage-commentscount-switch') && get_comments_number(ampforwp_get_the_ID()) ){ echo comments_number() .' | ';  } ?> </span>
