...
function ampforwp_new_dir( $dir ) {
	...
	function ampforwp_add_amp_social_share_script( $data ){
		...
		if( true == ampforwp_get_setting('ampforwp-facebook-like-button') && ( (true == ampforwp_get_setting('ampforwp-page-sticky-social') || $social_check_page ) || ( is_single() && (!checkAMPforPageBuilderStatus(ampforwp_get_the_ID())) ||  true == ampforwp_get_setting('enable-single-social-icons'))) && $social_check ){
