...
.lb-btn form #amp-search-submit:after{
    content: "\e8b6";
    font-family: 'icomoon';
    font-size: 23px;
   <?php if($redux_builder_amp['swift-element-color-control']){?>
        color: <?php echo $redux_builder_amp['swift-element-color-control']?>;
    <?php } else { ?> color:#000; <?php } ?>
    line-height: 0;
    display: block;
    background:transparent
