...
0.9. AMP Design Manager Files
	...
	9. Advertisement code [MOVED TO FEATURES]
	10. Analytics Area [MOVED TO FEATURES]
	...
	86. minify the content of pages [MOVED TO FEATURES]
	87. Post Thumbnail
	88. Author Details
	89. Facebook Pixel
...
function ampforwp_new_dir( $dir ) {
	...
	// 9. Advertisement code(MOVED)

	// 10. Analytics Area (MOVED TO FEATURED AREA)
