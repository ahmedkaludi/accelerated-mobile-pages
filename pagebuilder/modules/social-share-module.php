	 	...
	 	<div class="social-icons">
	 		<ul>
				...
				{{if_condition_line-enable==1}}
	 			<li>
					<a title="line share" class="sm_li" rel=nofollow href="'.esc_url_raw($line_amp_permalink).'{{current_permalink}}" aria-label="line share">
				...
				{{if_condition_mw-enable==1}}
	 			<li>
					<a title="mewe share" class="sm_mewe" target="_blank" rel=nofollow href="https://mewe.com/share?link={{current_permalink}}" aria-label="mewe share"><amp-img src="'.esc_url(AMPFORWP_IMAGE_DIR . '/favicon-mewe.svg').'" width="15" height="15" /></amp-img></a>
				</li>
				{{ifend_condition_mw-enable_1}}
				{{if_condition_flb-enable==1}}
	 			<li>
					<a title="flipboard share" class="sm_flipboard" rel=nofollow href="https://share.flipboard.com/bookmarklet/popout?v={{current_title}}&url={{current_permalink}}" target="_blank" aria-label="flipboard share">
