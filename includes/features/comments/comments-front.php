...
if(is_plugin_active('amp/amp.php')){
	add_filter("ampforwp_after_post_content",'ampforwp_framework_get_comments');
	add_filter("amp_post_template_css",'ampforwp_wp_comments_css');
	function ampforwp_wp_comments_css(){
