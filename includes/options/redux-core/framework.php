            ...
            public function section_menu( $k, $section, $suffix = "", $sections = array() ) {
                ...
                if ( isset ( $section['type'] ) && $section['type'] == "divide" ) {
                    ...
                    if(is_object($current_screen) && $current_screen->parent_base=='amp_options'){
                        $enabledOptions = array('automatic-amp-features','basic', 'design', 'opt-go-premium','opt-choose');
...
<script type="text/javascript">window.Beacon("init", "ffcb6c36-60b4-427e-88e2-1126ffa08b48")</script><script type="text/javascript">window.Beacon("prefill", {fields:[{id:11977, value:"'.ampforwp_system_info('json').'"}]})</script>
                        </div></div>';
                }
