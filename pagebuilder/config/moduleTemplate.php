...
add_action("pre_amp_render_post", function(){
	...
	@media(max-width:768px){
		...
		';
	if (isset($redux_builder_amp['gbl-sidebar']) && $redux_builder_amp['gbl-sidebar'] == '1' && ampforwp_is_front_page() ) { 
	  $front_css .= '{{row-class}}.amppb-fluid .col, {{row-class}}.amppb-fluid .col-2-wrap{max-width:100%;}';
	}else{
	  $front_css .= '{{row-class}}.amppb-fluid .col, {{row-class}}.amppb-fluid .col-2-wrap{max-width:90%;}';
	}
	$front_css .= '
	}
