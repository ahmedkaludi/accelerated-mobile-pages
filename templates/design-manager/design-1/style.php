...
a-so-share[type="facebookmessenger"] {
...
<?php if ( true == ampforwp_get_setting('enable-single-line-share') ) { ?>
  .custom-a-sosharing-line{background:#00b900}
<?php } ?>
<?php if ( true == ampforwp_get_setting('enable-single-vk-share') ) { ?>
.custom-a-sosharing-vk, .a-so-vk{background:#45668e}
<?php } ?>
...
.custom-a-sosharing-mewe{background:#b8d6e6}
.a-so-mewe{background:#b8d6e6}
<?php } ?>
<?php if ( true == ampforwp_get_setting('enable-single-flipboard-share') ) { ?>
.custom-a-sosharing-flipboard{background:#f52828}
.a-so-flipboard{background:#f52828;text-align: center;}
.a-so-flipboard amp-img , .a-so-i.custom-a-sosharing-flipboard amp-img {top: 2px;}
<?php } ?>
<?php if( !ampforwp_woocommerce_conditional_check() ) { ?>
...
.cmts_list ul li{font-size:11px;list-style-type:none;margin-bottom:12px;background:#fefefe;border-radius:2px;-webkit-border-radius:2px;border-radius:2px;box-shadow:0 2px 3px rgba(0,0,0,.05);-webkit-box-shadow:0 2px 3px rgba(0,0,0,.05);box-shadow:0 2px 3px rgba(0,0,0,.05);padding:0;max-width:1000px;width:96%}.cmts_list ul li .says{margin-right:4px}.cmts_list li li,.cmts_list li li li{margin:20px 20px 10px}.cmts_list ul li .cmt-body{padding:10px 0 15px}.cmt-author{float:left}.single-post footer.cmt-meta{padding-bottom:0;     line-height: 1.9;}.cmts_list li li{background:#f7f7f7;box-shadow:none;border:1px solid #eee} .page-numbers{ padding: 9px 10px; background: #fff; font-size: 14px; } .cmt-author-img{float: left; margin-right: 5px; border-radius: 60px;} .cmt-content amp-img{max-width: 300px;}
<?php } ?>
<?php } // AMP Woocommerce CSS Ends ?>
...
.amp-wp-content.the_content {word-break: break-word;}
<?php } ?>
