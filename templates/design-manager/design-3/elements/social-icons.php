...
<i class="icono-share"></i>
      ...
      $data_param_data = $redux_builder_amp['enable-single-twitter-share-handle']; ?>
			<div class="ampforwp-custom-social">
				<a title="twitter share" href="https://twitter.com/intent/tweet?url=<?php echo esc_url($amp_permalink); ?>&text=<?php echo esc_attr( get_the_title()); ?>&via=<?php echo esc_attr($data_param_data); ?>" class="amp-social-icon-rounded amp-social-twitter">
