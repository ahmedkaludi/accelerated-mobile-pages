    ...
    <i class="icono-share"></i>
      ...
      $data_param_data = $redux_builder_amp['enable-single-twitter-share-handle']; ?>
		...
		<?php if ( true == $redux_builder_amp['enable-single-linkedin-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="linkedin share" <?php ampforwp_nofollow_social_links(); ?> href="https://www.linkedin.com/shareArticle?url=<?php esc_url(the_permalink()); ?>&title=<?php the_title(); ?>" class="amp-social-icon-rounded amp-social-linkedin" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-line-share'] ) { ?>
			<div class="ampforwp-custom-social">
				<a title="line share" <?php ampforwp_nofollow_social_links(); ?> class="amp-social-line amp-social-icon-rounded" href="http://line.me/R/msg/text/?<?php echo esc_url($amp_permalink); ?>">
