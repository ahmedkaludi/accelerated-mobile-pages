...
.fbp-cnt p, .fsp-cnt p{color:#444;font-size:13px;line-height:20px;letter-spacing: 0.10px;}
...
.pg .cntn-wrp p {font-size: 18px;color: #000;line-height: 1.7;margin:20px 0px;}
<?php } ?>
<?php } ?>
