...
if(! is_plugin_active('structured-data-for-wp/structured-data-for-wp.php') && !defined( 'RANK_MATH_FILE' ) && ! is_plugin_active('schema-and-structured-data-for-wp/structured-data-for-wp.php') && ! class_exists('SQ_Classes_ObjController') ):
