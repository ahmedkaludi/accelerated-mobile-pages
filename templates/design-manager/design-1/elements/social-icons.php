...
if(true == ampforwp_get_setting('ampforwp-social-share')){ ?>
	<div class="ampforwp-social-icons">
		...
		if ( $data_param_data ) {
			...
			$twitter_amp_permalink =  add_query_arg($via_text, $data_param_data, $twitter_amp_permalink);
		}?>
		 <amp-social-share type="twitter"
				...
				data-param-url=""
				data-param-text="TITLE <?php echo esc_url($twitter_amp_permalink); ?>">
		</amp-social-share>
		<?php } ?>
		...
		<?php if($redux_builder_amp['enable-single-line-share'] == true)  { ?>
			<a title="line share" <?php ampforwp_nofollow_social_links(); ?> href="http://line.me/R/msg/text/?<?php echo esc_url($amp_permalink); ?>" aria-label="line share">
		...
		<?php if($redux_builder_amp['enable-single-vk-share'] == true)  { ?>
			<a title="vkontakte share" <?php ampforwp_nofollow_social_links(); ?> href="http://vk.com/share.php?url=<?php echo esc_url($amp_permalink); ?>" target="_blank" aria-label="vkontakte share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-reddit-share'] ) { ?>
			<a title="reddit share" <?php ampforwp_nofollow_social_links(); ?> href="https://reddit.com/submit?url=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars(get_the_title())); ?>" target="_blank" aria-label="reddit share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-tumblr-share'] ) { ?>
			<a title="tumblr share" <?php ampforwp_nofollow_social_links(); ?> href="https://www.tumblr.com/widgets/share/tool?canonicalUrl=<?php echo esc_url($amp_permalink); ?>&title=<?php echo esc_attr(htmlspecialchars(get_the_title())); ?>&caption=<?php echo esc_attr(get_the_excerpt()); ?>" target="_blank" aria-label="tumblr share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-telegram-share'] ) { ?>
			<a title="telegram share" <?php ampforwp_nofollow_social_links(); ?> href="https://telegram.me/share/url?url=<?php echo esc_url($amp_permalink); ?>&text=<?php echo esc_attr(htmlspecialchars(get_the_title())); ?>" target="_blank" aria-label="telegram share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-wechat-share'] ) { ?>
			<a title="wechat share" <?php ampforwp_nofollow_social_links(); ?> href="http://api.addthis.com/oexchange/0.8/forward/wechat/offer?url=<?php echo esc_url($amp_permalink); ?>" target="_blank" aria-label="wechat share">
		...
		<?php if ( true == $redux_builder_amp['enable-single-viber-share'] ) { ?>
			<a title="viber share" <?php ampforwp_nofollow_social_links(); ?> href="viber://forward?text=<?php echo esc_url($amp_permalink); ?>" target="_blank" aria-label="viber share">
		...
		<?php if ( true == ampforwp_get_setting('enable-single-mewe-share') ) { ?>
			<a title="mewe share" <?php ampforwp_nofollow_social_links(); ?> href="https://mewe.com/share?link=<?php echo esc_url($amp_permalink); ?>" target="_blank" aria-label="mewe share">
		...
		<?php if ( true == ampforwp_get_setting('enable-single-flipboard-share') ) { ?>
			<a title="flipboard share" <?php ampforwp_nofollow_social_links(); ?> href="https://share.flipboard.com/bookmarklet/popout?v=<?php echo esc_html(get_the_title(ampforwp_get_the_ID())); ?>&url=<?php echo urlencode(esc_url($amp_permalink)); ?>" target="_blank" aria-label="flipboard share">
