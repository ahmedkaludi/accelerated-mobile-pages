...
//          'icon'        => 'el el-podcast',
          ...
          array(
            ...
            'accordion-open'=> 1, 
                    ...
                    array(
                            'id'        => 'ampforwp-web-push-onesignal-header',
                            'type'      => 'switch',
                            'title'     => 'Header (Sitewide)',
                            'true'      => 'true',
                            'false'     => 'false', 
                            'default'   =>  0,
                            'tooltip-subtitle'  => 'Show Subscribe Button in the Header',
                            'required'  => array('ampforwp-web-push-onesignal', '=' , '1'),
                            ),
                    array(
                            'id'        => 'ampforwp-web-push-onesignal-sticky',
                            'type'      => 'switch',
                            'title'     => 'Sticky (Sitewide)',
                            'true'      => 'true',
                            'false'     => 'false', 
                            'default'   =>  0,
                            //'tooltip-subtitle'  => '',
