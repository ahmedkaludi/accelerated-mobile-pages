...
function ampforwp_socialmod($moduleFrontHtml, $htmlTemplate, $contentArray){
	...
	$moduleFrontHtml = str_replace('{{line_permalink}}', $line_amp_permalink, $moduleFrontHtml);
	 	...
	 	<div class="social-icons">
	 		<ul>
				...
				{{if_condition_line-enable==1}}
	 			<li>
					<a title="line share" class="sm_li" {{if_condition_nofollow-enable==1}}rel=nofollow{{ifend_condition_nofollow-enable_1}} href="{{line_permalink}}{{current_permalink}}" aria-label="line share">
