		...
		<div class="cntr">
			<div class="sp-rl">
				<div class="sp-rt">
					...
					<?php 
					// if you want to add anything before or after the content then you can use 'ampforwp_before_post_content' or 'ampforwp_after_post_content' hooks 	
					amp_content(); 
					?>
					</div>
		...
		while( amp_loop('start', array( 'posts_per_page' => $number_of_posts ) ) ): ?>
			<div class="fsp">
			    ...
			    <div class="fsp-cnt">
				    ...
				    <?php //$data['link'] = ' sdnbnbjnvgljvgjj';
				    amp_loop_title(); ?>
